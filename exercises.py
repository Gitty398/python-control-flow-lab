...
def check_voting_eligibility():
    input_age = input('Please enter a your age: ')
    age = int(input_age)
...
def calculate_dog_years():
    input_age = int(input("Input a dog's age: "))
    
    if input_age == 1:
        print("Your dog is 10 in human years")

    elif input_age == 2:
        print("Your dog is 20 in human years")

    else:
        age = 20 + (input_age - 2) * 7
        print(f'Your dog is {age} in human years')
...
def weather_advice():
    cold = input("Is it cold outside (yes/no) ").lower() == "yes"
